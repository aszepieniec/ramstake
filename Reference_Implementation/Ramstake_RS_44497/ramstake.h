...
#define RAMSTAKE_CODEWORD_NUMBER 13
#define RAMSTAKE_ADDITIVE_MASS 118
#define RAMSTAKE_MULTIPLICATIVE_MASS 10
...
#define RAMSTAKE_MODULUS_BITSIZE 216091
...
#define RAMSTAKE_CIPHERTEXT_LENGTH ((RAMSTAKE_MODULUS_BITSIZE+7)/8 + RAMSTAKE_SEEDENC_LENGTH + RAMSTAKE_KEY_LENGTH)
